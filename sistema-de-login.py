...
tentativas = 1 #tentativas inicialmente definida em 1.

while tentativas < 4: #tentativas totais definida em 3.
    ...
    if usuario == user and senha == password: #se seu login for igual ao usuario criado, e sua senha digitada for igual a criado. Seu login foi efetuado.
        ...
        exit(0)
    elif usuario != user or senha != password and tentativas == 3: #se existir algo diferente, e as tentativas for maior do que 2, vc bloqueou o sistema.
